package com.example.gfup2.constants;

public class Constants {
    public static final String REFRESH_TOKEN = "refreshToken";
    public static final String REFRESH_TOKEN_EXPIRATION = "expirationTimeFromRefreshToken";
    public static final String ACCESS_TOKEN = "accessToken";
    public static final String ACCESS_TOKEN_EXPIRATION = "expirationTimeFromAccessToken";
    ...
    public static final String SIGNUP_PHONE_NUMBER_DIFFERENT_ERROR = "입력된 전화번호와 이늦ㅇ된 전화번호 다름";
